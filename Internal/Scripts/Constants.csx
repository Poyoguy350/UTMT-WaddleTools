...
public string INTERNAL_DIR = Path.Combine(Path.GetDirectoryName(ScriptPath), "Internal");
public string ASSETS_DIR = Path.Combine(INTERNAL_DIR, "Assets");

// touch this later or something
